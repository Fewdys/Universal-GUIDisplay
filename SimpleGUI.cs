    ...
    public class SimpleGUI : MelonMod
    {
        public override void OnGUI()
        {
            try
            {
                ...
                GUI.Label(new Rect(3f, 24f, 160f, 90f), $"<color=red>Time: </color><color=cyan>{DateTime.Now.ToString("h:m:s tt")}\n</color>");
                GUI.Label(new Rect(3f, 36f, 160f, 90f), $"<color=red>FPS: </color><color=cyan>{(int)(1.0f / Time.smoothDeltaTime)}\n</color>");
            }
